...
from .VP_ReplayBuffer_V2 import VP_ReplayBuffer
...
class VP_DDPG(OffPolicyRLModel):
    ...
    def setup_model(self):
        with SetVerbosity(self.verbose):
            ...
            with self.graph.as_default():
                ...
                self.replay_buffer = VP_ReplayBuffer(self.buffer_size, self.env.env_method('_get_target_turbulence')[0])
    ...
    def _train_step(self, step, writer, log=False):
        ...
        """
        # Get a batch
        obs, actions, rewards, next_obs, terminals = self.replay_buffer.sample(batch_size=self.batch_size, env=self._vec_normalize_env)
